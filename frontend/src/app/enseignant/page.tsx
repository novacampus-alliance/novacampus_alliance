...
import { Card, StatCard, FiliereBadge } from '@/components/ui';
...
export default function EnseignantDashboardPage() {
  ...
  return (
    <AppShell title="Tableau de bord" subtitle="Bonjour Marie 👋">
      <div className="mb-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard label="Cours animes" value={String(courses.length)} />
        <StatCard label="Etudiants" value={String(totalStudents)} />
        <StatCard
                ...
                >
                  <div>
                    ...
                    <div className="text-xs text-gray-600">
                      {c.enrolledCount} inscrits · moyenne {c.averageGrade.toFixed(1)}
                    </div>
                  </div>
